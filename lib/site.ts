export const site = {
  ...
  shortName: "Sagnik",
  tagline: "Builder of agentic systems, real-time ML and the infrastructure underneath.",
  longTagline:
  ...
  resumes: [
    { label: "Resume — MLE / MLOps / AIE", href: "/resume/sagnik-mukherjee-resume-MLE_MLOps_AIE.pdf" },
    { label: "Resume — SDE / SRE", href: "https://drive.google.com/file/d/1KtVdYihrigosEW4BvP8VJEz710CnXZzL/view?usp=drive_open" },
  ],
  nav: [
